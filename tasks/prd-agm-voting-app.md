...
- **Database:** PostgreSQL
- **ORM:** SQLAlchemy with Alembic for migrations; migrations run automatically on server startup in development; a `make migrate` command is provided for explicit runs
